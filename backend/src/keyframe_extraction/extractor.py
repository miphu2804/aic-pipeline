...
from keyframe_extraction.models import DakeKeyframeCandidate
...
class KeyframeExtractor:
    """Selects keyframes from a video using U-CESE Algorithm 1 (U-CESE, 2025)."""

    def __init__(
        self, rho: float = 0.02, jpeg_qscale: int = 2, warmup_seconds: float = 0.5
    ) -> None:
        self.rho = rho
